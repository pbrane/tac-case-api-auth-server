...
RUN apt-get update && apt-get install -y reptyr dnsutils bind9-utils net-tools iproute2 iputils-ping iputils-tracepath ncat screen && apt-get clean && rm -rf /var/lib/apt/lists/*
